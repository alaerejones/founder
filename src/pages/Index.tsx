...
const Index = () => {
  return (
    <div className="min-h-screen">
      ...
      {/* Ventures & Leadership Section - Premium Redesign */}
      <section id="ventures" className="py-20 lg:py-20 bg-white">
        <div className="container mx-auto px-4 lg:px-6">
          ...
          {/* Ventures Grid - Real Images & Professional Cards */}
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 mb-16">
            {/* Sinocle Nigeria Limited - Real Estate */}
            <div className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="relative h-64 lg:h-80 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                  <span className="text-xs font-bold text-primary">Real Estate</span>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="text-xl lg:text-2xl font-bold mb-1">Sinocle Nigeria Limited</h3>
                  <p className="text-sm opacity-90">Premier Development Projects</p>
                </div>
              </div>
            ...
            <div className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="relative h-64 lg:h-80 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="text-xl lg:text-2xl font-bold mb-1">Sinocle Energy Solutions</h3>
            ...
            <div className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="relative h-64 lg:h-80 overflow-hidden">
                ...
                />
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                  <span className="text-xs font-bold text-primary">Technology</span>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="text-xl lg:text-2xl font-bold mb-1">iLunar Technologies</h3>
            ...
            <div className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="relative h-64 lg:h-80 overflow-hidden">
                ...
                />
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                  <span className="text-xs font-bold text-primary">Agriculture</span>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="text-xl lg:text-2xl font-bold mb-1">Sinocle AgroSolutions</h3>
          ...
          {/* Statistics Bar */}
          <div className="bg-muted rounded-xl p-6 lg:p-8 border border-gray-100">
      ...
      {/* Media & Insights Section - Improved Mobile Video */}
      <section id="media" className="py-20 lg:py-20 bg-muted/30">
        <div className="container mx-auto px-4 lg:px-6">
          ...
          {/* Featured Video - Mobile Optimized */}
          <div className="max-w-5xl mx-auto mb-16 lg:mb-20">
            {/* Desktop Version */}
            <div className="hidden lg:block bg-white rounded-xl p-8 shadow-xl border border-gray-100">
            ...
            <div className="block lg:hidden">
              <div className="text-center mb-6 px-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Insights on Africa's entrepreneurial future
                </p>
              </div>
              <div className="relative overflow-hidden rounded-lg">
                <iframe 
          ...
          {/* Press Coverage - Clickable External Links */}
        ...
        <div className="container mx-auto px-4 lg:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-2">ECOWAS Youth Ambassador</h3>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-2">Leadership Excellence</h3>
                ...
                <div className="bg-white rounded-xl p-6 lg:p-8 shadow-xl border border-gray-100">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-100">
                    ...
                    <div className="flex space-x-4">
                      <a href="https://linktr.ee/sinocle_nigeria_limited" target="_blank" className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-primary-foreground hover:bg-primary/90 transition-colors">
                      ...
                      <a href="https://www.linkedin.com/in/israel-chima-onyeolu-025aab1a0?" target="_blank" className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-primary-foreground hover:bg-primary/90 transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                        </svg>
                      </a>
                      <a href="https://x.com/israelonyeolu?s=11" target="_blank" className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-primary-foreground hover:bg-primary/90 transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                        </svg>
                      </a>
                      <a href="https://www.instagram.com/ionyeolu?igsh=MXJtaTFyaXVhdnVpaw==" target="_blank" className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-primary-foreground hover:bg-primary/90 transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">

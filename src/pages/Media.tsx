        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link to="/media" className="text-sm font-semibold tracking-wider text-primary">MEDIA & INSIGHTS</Link>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-bold text-foreground mb-2">Onyeolu Israel Chima Bags Award</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-bold text-foreground mb-2">Godfatherism Cause of Leadership Failure</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-bold text-foreground mb-2">Entrepreneurial Trait Gaining Recognition</h3>

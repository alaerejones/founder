      ...
      <div className="container mx-auto px-4 lg:px-6 relative z-10">
        <div className="flex items-center justify-center lg:justify-start">
          ...
          <div className="space-y-6 lg:space-y-8 text-center lg:text-left max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-fade-in justify-center lg:justify-start">
              <Link to="/ventures">
              ...
              <Link to="/contact">
                <Button variant="outline" size="lg" className="w-full sm:w-auto border-secondary text-secondary hover:bg-secondary hover:text-primary px-6 lg:px-8 hover-scale">
                  Partner with Me
                </Button>
              </Link>
            </div>
            ...
            <div className="inline-flex bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-3 border border-white/20 animate-fade-in">

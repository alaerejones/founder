        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end order-1 lg:order-2">
            ...
            <div className="relative group">
              ...
              {/* Floating Achievement Badge - mobile repositioned only */}
              <div className="absolute -bottom-6 right-0 sm:-bottom-10 sm:left-1/2 sm:-translate-x-1/2 bg-background border border-border rounded-lg shadow-lg p-3">

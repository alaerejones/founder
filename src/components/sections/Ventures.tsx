  ...
  return (
    <section className="py-16 lg:py-20 bg-gradient-to-b from-white to-muted/20">
      <div className="container mx-auto px-4 lg:px-6">
        {/* Header - Centered with responsive alignment */}
        <div className="mb-16 lg:mb-20 text-center lg:text-left">
          ...
          <p className="text-base lg:text-lg text-muted-foreground max-w-4xl leading-relaxed text-justify mx-auto lg:mx-0">
